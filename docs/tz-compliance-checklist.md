...
Останнє оновлення: 2026-03-17 (ітерація 86).
...
- 🔜 Після першого прогона на цільовій машині додати у `docs/tz-compliance-checklist.md` фактичний timestamp/результат виконання `qa-stand-check` та `go-no-go-check`.
