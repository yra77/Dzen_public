...
- Оновлено документ відповідності ТЗ: залишено лише актуальний стан і робочий план.
- Усунуто Angular warning `NG8102` у сторінках root-list/thread через явне nullable-типізування кешу preview вкладень (`Record<string, string | undefined>`).
