...
4. **P1 — GraphQL quality:** додати контрактні перевірки GraphQL-запитів/мутацій (включно з негативними кейсами) у CI та e2e перевірку retry/validation UX.
...
- **P1 GraphQL quality:** додати контрактні перевірки GraphQL-операцій (позитивні + негативні кейси) у CI та e2e-сценарії для GraphQL validation/transient UX.
