...
Останнє оновлення: 2026-03-21 (P0-синхронізація README/checklist по БД + UI-оновлення кнопки відповіді).
...
- Оновлено README-блок про БД, щоб прибрати розбіжності між handoff-описом та checklist.
- Для UI-кнопки відповіді в SPA додано SVG-іконку через фронтенд-asset (`/images/answer-white.svg`) замість тексту "Відповісти".
